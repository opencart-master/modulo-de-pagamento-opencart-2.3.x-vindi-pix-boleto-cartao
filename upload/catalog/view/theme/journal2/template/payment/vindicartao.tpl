...
<form class="form-horizontal" id="form-pay" data-yapay="payment-form">
  <fieldset id="payment">
	...
	<div class="form-group required">
	 <label class="col-sm-2 control-label" for="cc_number"><?php echo $entry_cc_number; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
	 <label class="col-sm-2 control-label" for="cc_data"><?php echo $entry_cc_mes; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
	 <label class="col-sm-2 control-label" for="cc_data1"><?php echo $entry_cc_ano; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
	 <label class="col-sm-2 control-label" for="cc_name"><?php echo $entry_cc_name; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
	  <label class="col-sm-2 control-label" for="cc_doc"><?php echo $entry_cc_doc; ?></label>
      <div class="col-sm-10">
     ...
     <div class="form-group required">
	  <label class="col-sm-2 control-label" for="cc_parc"><?php echo $entry_cc_parc; ?></label>
      <div class="col-sm-10">
