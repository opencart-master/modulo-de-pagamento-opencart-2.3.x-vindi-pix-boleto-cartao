  ...
  <div class="container-fluid">
    ...
    <div class="tab-pane active" id="tab-general">
		<div class="form-group required">
            ...
            <div class="col-sm-10">
             <input type="text" name="vindipix_title" value="<?php echo $vindipix_title; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title" class="form-control" />
			  <?php if ($error_title) { ?>
         ...
         <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="vindipix_token" value="<?php echo $vindipix_token; ?>" placeholder="<?php echo $entry_token; ?>" id="input-token" class="form-control" />
			  <?php if ($error_token) { ?>
         ...
         <div class="form-group" style="display:none;">
            ...
            <div class="col-sm-10">
              <input type="text" name="vindipix_days" value="<?php echo $vindipix_days; ?>" placeholder="<?php echo $entry_days; ?>" id="input-days" class="form-control" />
            </div>
          </div>
		 <div class="form-group required">
		 <label class="col-sm-2 control-label"><?php echo $entry_doc; ?></label>
			 <div class="col-sm-10">
			        <select name="vindipix_doc" id="input-doc" class="form-control">
				    <option value=""><?php echo $text_none; ?></option>
				    <?php foreach($custom_fields as $custom_field) { ?>
				     <?php if ($custom_field['location'] == 'account') { ?>
					<?php if ($vindipix_doc == $custom_field['custom_field_id']) { ?>
		 ...
		 <label class="col-sm-2 control-label"><?php echo $entry_doc2; ?></label>
			 <div class="col-sm-10">
			        <select name="vindipix_doc2" id="input-doc" class="form-control">
				    <option value=""><?php echo $text_none; ?></option>
				    <?php foreach($custom_fields as $custom_field) { ?>
				     <?php if ($custom_field['location'] == 'account') { ?>
					<?php if ($vindipix_doc2 == $custom_field['custom_field_id']) { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>" selected><?php echo $custom_field['name']; ?></option>
					<?php } else { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></option>
					<?php } ?>
		 ...
		 <label class="col-sm-2 control-label"><?php echo $entry_raz; ?></label>
			 <div class="col-sm-10">
			        <select name="vindipix_raz" id="input-doc" class="form-control">
				    <option value=""><?php echo $text_none; ?></option>
				    <?php foreach($custom_fields as $custom_field) { ?>
				     <?php if ($custom_field['location'] == 'account') { ?>
					<?php if ($vindipix_raz == $custom_field['custom_field_id']) { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>" selected><?php echo $custom_field['name']; ?></option>
					<?php } else { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></option>
					<?php } ?>
		 ...
		 <label class="col-sm-2 control-label"><?php echo $entry_number; ?></label>
			 <div class="col-sm-10">
			        <select name="vindipix_number" id="input-number" class="form-control">
				    <option value=""><?php echo $text_none; ?></option>
				    <?php foreach($custom_fields as $custom_field) { ?>
				     <?php if ($custom_field['location'] == 'address') { ?>
					<?php if ($vindipix_number == $custom_field['custom_field_id']) { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>" selected><?php echo $custom_field['name']; ?></option>
					<?php } else { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></option>
					<?php } ?>
		 ...
		 <label class="col-sm-2 control-label"><?php echo $entry_complement; ?></label>
			 <div class="col-sm-10">
			        <select name="vindipix_complement" id="input-complement" class="form-control">
				    <option value=""><?php echo $text_none; ?></option>
				    <?php foreach($custom_fields as $custom_field) { ?>
				     <?php if ($custom_field['location'] == 'address') { ?>
					<?php if ($vindipix_complement == $custom_field['custom_field_id']) { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>" selected><?php echo $custom_field['name']; ?></option>
					<?php } else { ?>
					<option value="<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></option>
					<?php } ?>
		 ...
		 <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="vindipix_total" value="<?php echo $vindipix_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_order_status_pen; ?></label>
            <div class="col-sm-10">
              <select name="vindipix_order_status_id" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $vindipix_order_status_id) { ?>
		...
		<div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="vindipix_order_status_id1" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $vindipix_order_status_id1) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="vindipix_order_status_id2" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $vindipix_order_status_id2) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
	      ...
	      <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="vindipix_order_status_id3" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $vindipix_order_status_id3) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="vindipix_geo_zone_id" id="input-geo-zone" class="form-control">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $vindipix_geo_zone_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="vindipix_sort_order" value="<?php echo $vindipix_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
              <select name="vindipix_status" id="input-status" class="form-control">
                <?php if ($vindipix_status) { ?>
